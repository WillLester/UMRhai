...
//		System.out.println(this.getWidth() + " " + this.getHeight());
		...
		personalInfo.setBounds(Constants.WIDTH_DIV_9, Constants.LABEL_Y, Constants.LABEL_WIDTH, Constants.LABEL_HEIGHT_L);
		add(personalInfo);
		
		JLabel name = new JLabel("姓名");
		name.setFont(new Font("华文新魏", Font.PLAIN, 20));
		name.setBounds(Constants.WIDTH_DIV_9, 3*Constants.LABEL_Y, Constants.LABEL_WIDTH, Constants.LABEL_HEIGHT_S);
		add(name);
		
		JLabel org = new JLabel("机构");
		org.setFont(new Font("华文新魏", Font.PLAIN, 20));
		org.setBounds(Constants.WIDTH_DIV_9, 4*Constants.LABEL_Y, Constants.LABEL_WIDTH, Constants.LABEL_HEIGHT_S);
		add(org);
		
		JLabel post = new JLabel("职务");
		post.setFont(new Font("华文新魏", Font.PLAIN, 20));
		post.setBounds(Constants.WIDTH_DIV_9, 5*Constants.LABEL_Y, Constants.LABEL_WIDTH, Constants.LABEL_HEIGHT_S);
		add(post);
		
		JLabel mobile = new JLabel("手机号");
		mobile.setFont(new Font("华文新魏", Font.PLAIN, 20));
		mobile.setBounds(Constants.WIDTH_DIV_9, 6*Constants.LABEL_Y, Constants.LABEL_WIDTH, Constants.LABEL_HEIGHT_S);
		add(mobile);
