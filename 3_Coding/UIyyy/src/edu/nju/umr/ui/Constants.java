...
public class Constants {
	public static final int FRAME_WIDTH = MainFrame.FRAME_WIDTH;
	public static final int FRAME_HEIGHT = MainFrame.FRAME_HEIGHT;
	public static final int LABEL_X = FRAME_WIDTH/9;
	public static final int LABEL_Y = FRAME_HEIGHT/10;
	public static final int LABEL_WIDTH = FRAME_WIDTH/9;
	public static final int LABEL_HEIGHT_L = FRAME_HEIGHT/7;
	public static final int LABEL_HEIGHT_S = FRAME_HEIGHT/20;
	public static final int BUTTON_X = FRAME_WIDTH/15;
	public static final int BUTTON_Y = FRAME_WIDTH/20;
	public static final int BUTTON_WIDTH_S = FRAME_WIDTH/18;
	public static final int BUTTON_WIDTH_L = FRAME_WIDTH/10;
	public static final int BUTTON_HEIGHT = FRAME_HEIGHT/20;
	public static final int TEXTFIELD_X = FRAME_WIDTH/5;
	public static final int TEXTFIELD_Y = FRAME_HEIGHT/10;
