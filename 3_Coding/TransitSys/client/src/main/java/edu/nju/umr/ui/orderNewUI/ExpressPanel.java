...
public class ExpressPanel extends JPanel {
	...
	public ExpressPanel(JFrame fr) {
		...
		senderPhoneLabel.setBounds(585, 233, 62, 24);
		...
		senderPhoneField.setBounds(642, 233, 216, 25);
		...
		receiverLocLabel.setBounds(453, 301, 62, 24);
		...
		receiverLocField.setBounds(512, 301, 165, 25);
		...
		receiverCompanyLabel.setBounds(690, 301, 62, 24);
		...
		receiverCompanyField.setBounds(751, 301, 165, 25);
		...
		receiverPhoneLabel.setBounds(585, 342, 62, 24);
		...
		receiverPhoneField.setBounds(642, 342, 216, 25);
