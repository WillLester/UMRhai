...
public class RecipientPanel extends JPanel {
	...
	public RecipientPanel(JFrame fr) {
		...
		lblNewLabel_1.setBounds(342, 216, 107, 24);
		add(lblNewLabel_1);
		
		textField = new JTextField();
		textField.setFont(new Font("宋体", Font.PLAIN, 20));
		textField.setBounds(474, 216, 193, 24);
		add(textField);
		...
		comboBox.setBounds(474, 166, 193, 21);
		add(comboBox);
