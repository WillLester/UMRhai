...
//		this.add(existButton);
		...
		stockOutButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				fr.setContentPane(new StockOutPanel(fr,user.getName(),user.getOrgId(),user.getId(),user.getOrg()));
			}
		});
		...
		stockInButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				fr.setContentPane(new StockInPanel(fr,user.getName(),user.getOrgId(),user.getId(),user.getOrg()));
			}
		});
	}
