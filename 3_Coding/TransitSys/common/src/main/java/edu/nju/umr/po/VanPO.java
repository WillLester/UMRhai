...
public class VanPO extends PO implements Serializable{
	...
	public String getCommand(MysqlOperation op) {
		...
		case FIND:
			...
			break;
		case UPDATE:command="update van set plateNum='"+plateNum+"',servTime='"+DateFormat.DATE.format(servTime.getTime())+"',photo = 'vanImage/"+id+".jpg"+"',hallId = '"+hallId+"' where id='"+id+"'";break;
		}
		return command;
	}
