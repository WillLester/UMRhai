...
public class OrderApproveData extends UnicastRemoteObject implements OrderApproveDSer{
	...
	public PO getOrder(String id,Order kind) throws RemoteException {
		...
		switch(kind){
		case ARRIVE:
			po = new ArrivePO(null, null, id, null, null, null, null);
			return OrderPOFactory.getArrive(mysqlSer.checkInfo(po));
		case CENTERLOADING:
			po = new CenterLoadingPO(null, id, null, null, null, null, null, null, null, 0);
			return OrderPOFactory.getCenterLoad(mysqlSer.checkInfo(po));
		case EXPRESS:
			po = new ExpressPO(null, null, null, null, null, null, null, null, null, null, 0, null, 0, 0, 0, 0, 0, id, null, null, null, 0, null, null, null, null, null, null, null);
			return OrderPOFactory.getExpress(mysqlSer.checkInfo(po));
		case HALLLOADING:
			po = new HallLoadingPO(id, null, null, null, null, null, null, null, null, null, null, 0);
			return OrderPOFactory.getHallLoad(mysqlSer.checkInfo(po));
		case INCOME:
			po = new IncomePO(null, null, 0, null, Integer.parseInt(id), null, null, null);
		...
		case SEND:
			po = new SendPO(null, null, id, null, null, null);
			return OrderPOFactory.getSend(mysqlSer.checkInfo(po));
		case STOCKIN:
			po = new StockInPO(Integer.parseInt(id), null, null, null, null, null, 0, 0, null, null, null);
