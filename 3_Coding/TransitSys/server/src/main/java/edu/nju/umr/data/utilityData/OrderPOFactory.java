		...
		try {
			if(result.next()){
				...
				return new CenterLoadingPO(date, result.getString(1), result.getString(2), result.getString(3), 
						...
						,result.getString(11),result.getBoolean(12),result.getString(13),result.getString(14));
			} else {
				return null;
			}
		} catch (SQLException e) {
		...
		try {
			if(result.next()){
				...
				return new IncomePO(date, result.getString(2), result.getBigDecimal(3), express, 
						result.getString(1), opTime, result.getString(7), result.getString(8),result.getString(9)
						,result.getString(10));
			} else {
				return null;
			}
		...
		try {
			if(result.next()){
				...
				return new TransitPO(result.getString(1), result.getString(2), result.getString(3), result.getString(4), 
						...
						result.getDouble(10),result.getString(12),Transit.values()[result.getInt(13)],result.getBoolean(14),result.getString(15));
			} else {
				return null;
			}
		} catch (SQLException e) {
